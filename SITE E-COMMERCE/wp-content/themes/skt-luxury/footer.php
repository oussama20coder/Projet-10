...
<div id="footer-wrapper">
    ...
    <div class="footersocial">
    	...
    	<?php 
            ...
            <?php }  
            if (!empty($gplus_link)) { ?>
            <a title="<?php echo esc_attr__('Google Plus','skt-luxury'); ?>" class="gp" target="_blank" href="<?php echo esc_url($gplus_link); ?>"></a> 
            <?php }   
...
<div class="container">
     <div class="copyright-txt"><?php echo esc_html('&copy; Copyright 2019 SKT Luxury All Rights Reserved.');?></div>
     <div class="clear"></div>
</div>           
</div>
</div><!--end .footer-wrapper-->
